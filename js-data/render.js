function renderQuestion(question, count, array) {
    return `<h2 class="question">${question['question']}</h2>
            ...
            <div class="question-footer">
                <button id="back-button" disabled onclick="nextQuestion(${count}, ${array})">Back</button>
                <button id="next-button" disabled onclick="nextQuestion(${count}, ${array})">Next</button>
            </div>`
}
    ...
    return `<div class="startselection display-between-center">
            ...
            <div class="answer flex-column-between">
                <div id="answer_1" class="question-progress">
                    <span>HTML</span><span>1 / 5</span>
                </div>
                <div id="answer_2" class="question-progress">
                    <span>CSS</span><span>1 / 5</span>
                </div>
                <div id="answer_3" class="question-progress">
                    <span>Javascript</span><span>1 / 5</span>
                </div>
                <div id="answer_4" class="question-progress">
                    <span>Java</span><span>1 / 5</span>
                </div>
            </div>`
}
