...
function returnAnswer(questionarray, array, id, countid) {
    if (countid.length == 0) {
        showStartscreen('start');
    } else {
        countid.pop();
        questions(questionarray, array, id, countid);
    }
}
...
function showResponsiveMenu() {
    let showmenu = document.getElementById('quiz-selection');
    showmenu.classList.toggle('show-quiz-selection');
}


function hideResponsiveMenu() {
    let showmenu = document.getElementById('quiz-selection');
    showmenu.classList.remove('show-quiz-selection');
}